...
@section('content')
    ...
    <div class="bg-primary">
        <h2 class="d-flex justify-content-center text-light py-4  m-0">Screening in your area</h2>
    </div>
    ...
    {{-- Advert --}}
    <div class="pt-4">
        <img src="https://i.imgur.com/8hfZPol.jpg" class="d-block w-100" height="300px" alt="advert-1">
    </div>
    {{-- End of Advert --}}
