...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $movies->movie_image_wide = "puss_in_boots_wide.jpg";
        ...
        $movies->movie_image_wide = "scream_6_wide.jpeg";
        ...
        $movies->movie_image_wide = "mario_wide.jpg";
        ...
        $movies->movie_image_wide = "crred3_wide.jpg";
        ...
        $movies->movie_image_wide = "65_wide.jpg";
        ...
        $movies->movie_image_wide = "cocaine_bear_wide.jpg";
        ...
        $movies->movie_image = "into_the_spiderverse.jpg";
        $movies->movie_image_wide = "puss_in_boots_wide.jpg";
